...
import { type LidJid } from './lidCache';
...
declare class BaileysProvider extends ProviderClass<WASocket> {
     ...
     */
    getPNForLID: (lid: string | LidJid) => Promise<string | null>;
    /**
     ...
     */
    sendAudio: (number: string, audioPath: string, isPTT?: boolean) => Promise<WAMessage>;
    /**
     *
     * @param {string} number
     * @param {string} message
